...
class Parser(object):
    ...
    def __init__(self, dataset):
        ...
        # Token to index of dependency relation
        ...
        # A dictionary with dependency relation, POS_tag and word
        self.tok2id = tok2id
...
class ModelWrapper(object):
    ...
    def predict(self, partial_parses):
        mb_x = [self.parser.extract_features(p.stack, p.buffer, p.dependencies, self.dataset[self.sentence_id_to_idx[id(p.sentence)]]) for p in partial_parses]
...
def punct(language, pos):
    if language == 'english':
        ...
        return pos in ["f0", "faa", "fat", "fc", "fd", "fe", "fg", "fh", "fia", "fit", "fp", "fpa", "fpt", "fs", "ft", "fx", "fz"]
